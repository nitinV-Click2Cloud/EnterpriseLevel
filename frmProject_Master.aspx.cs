...
namespace TTSHWeb
{
    ...
    {
        public Project_Master _Project_Master { get; set; } = null;
        public List<Project_Dept_PI> pdi { get; set; } = null;
        public List<Project_Coordinator_Details> pcd { get; set; } = null;
        public List<PI_Master> DEPT_PI { get; set; } = null;
