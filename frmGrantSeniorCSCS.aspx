<%@ Page Title="" Language="C#" MasterPageFile="~/TTSHMasterPage/TTSH.Master" AutoEventWireup="true" CodeBehind="frmGrantSeniorCSCS.aspx.cs" Inherits="TTSHWeb.frmGrantSeniorCSCS" %>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        ...
                        <p>
                            ...
                            <asp:TextBox ID="TxtApprDate" CssClass="ctlinput ctlinput-sm datepicker " runat="server"></asp:TextBox>
                        </p>
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <p>
                        ...
                        <p>
                            ...
                            <asp:TextBox ID="TxtNExpDate" CssClass="ctlinput ctlinput-sm datepicker " runat="server"></asp:TextBox>
                        </p>
                        <p>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                    <p>
                        ...
                        <span>
                            <asp:LinkButton ID="LnkAwardLetterDwnlod" runat="server"></asp:LinkButton></span>
                    </p>
                    <p>
                        <label>Projected Time</label>
                        <asp:TextBox ID="TxtprojectTime" CssClass="ctlinput" runat="server"></asp:TextBox>
                    </p>
        ...
        <div class="row margin-top frmAction">
            <div class="col-md-12">
                <p style="text-align: right">
                    ...
                    <asp:Button CssClass="action" ID="btnSave" runat="server" OnClientClick="return IsValidate();" Text="Save Details" />
